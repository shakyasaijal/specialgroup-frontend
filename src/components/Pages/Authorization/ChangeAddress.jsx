...
const ChangeAddress = () => {
    const [state, setState] = React.useState({ "hasAddress": true, "city": "Lalitpur", "address": "Civil Homes - VI, dhapakhel", "msg": "" })
    ...
    return (
        <div className="row">
            <div className="change-address center">
                <h3 className="page-title medium-dark">
                    Your Address
                </h3>
                {
                    state.hasAddress ? <small className="small">Your default address has been set when you signed up. You can change delivery address during checkout as well.</small> : ''
                }
